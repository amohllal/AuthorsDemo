...
import com.assignment.clientapp.presentation.views.adapter.RecyclerViewClickListener
...
class AuthorsFragment : Fragment(), RecyclerViewClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        authorAdapter = AuthorRecyclerAdapter(authorList, this, requireContext())
    ...
    override fun onRecyclerViewItemClick(author: AuthorsDomainResponseItem) {
    }
